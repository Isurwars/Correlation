...
TEST_F(_21_StructureFactorCalculator_Tests, CalculatesSimpleCubicBraggPeak) {
...
TEST_F(_21_StructureFactorCalculator_Tests, SingleAtomGivesOne) {
  correlation::core::Cell cell(
...
TEST_F(_21_StructureFactorCalculator_Tests, DimerProducesValidSQ) {
...
TEST_F(_21_StructureFactorCalculator_Tests,
...
TEST_F(_21_StructureFactorCalculator_Tests, HomonuclearClusterPartialsPresent) {
  correlation::core::Cell cell({20.0, 20.0, 20.0, 90.0, 90.0, 90.0});
  cell.addAtom("Si", {0.0, 0.0, 0.0});
