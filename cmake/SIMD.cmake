...
add_library(correlation_simd_options INTERFACE)
if (CORRELATION_SIMD_FLAGS)
    separate_arguments(SIMD_FLAGS_LIST NATIVE_COMMAND "${CORRELATION_SIMD_FLAGS}")
    target_compile_options(correlation_simd_options INTERFACE ${SIMD_FLAGS_LIST})
endif()
