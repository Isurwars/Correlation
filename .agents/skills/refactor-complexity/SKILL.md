...
description: Guide architectural refactoring to keep function cognitive complexity strictly below threshold (<= 25). Decomposes monolithic functions into modular subroutines and parameter structs without inline suppressions. Use when resolving clang-tidy cognitive complexity warnings.
---
