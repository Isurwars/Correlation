---
name: benchmarking
description: Enforce data-oriented design (SoA vs AoS), SIMD vectorization, Google Benchmark microbenchmarks, and cache-line alignment. Use when profiling or optimizing throughput and latency.
---

# Microbenchmarking & Performance Optimization
