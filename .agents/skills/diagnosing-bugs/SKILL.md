...
description: Disciplined debugging and diagnosis loop for hard bugs, compiler errors, linker failures, and runtime regressions. Use when something is broken, throwing, failing, or slow.
---
