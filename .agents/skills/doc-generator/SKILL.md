---
name: doc-generator
description: Audit C++ headers for missing Doxygen documentation blocks, validate tag completeness (@param, @return, @throws), and format compliant block comments. Use when documenting APIs or auditing header comments.
---
