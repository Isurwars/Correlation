---
name: concurrency
description: Enforce thread-safety rules for OpenMP and TBB loops, std::scoped_lock synchronization, atomic state management, and cache alignment in parallel structural calculators. Use when writing, debugging, or profiling multi-threaded algorithms.
---

# Concurrency & Parallel Patterns
