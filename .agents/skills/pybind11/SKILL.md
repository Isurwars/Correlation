---
name: pybind11
description: Direct high-performance Python bindings creation, zero-copy NumPy buffer transfers, GIL management, and C++/Python memory safety. Use when editing or reviewing Python bindings in src/bindings/.
---
