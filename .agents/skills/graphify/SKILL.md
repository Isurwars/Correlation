---
name: graphify
description: Maintain and regenerate Graphify knowledge graph to eliminate context drift and enable caveman navigation. Use when files are added, moved, or deleted.
---
