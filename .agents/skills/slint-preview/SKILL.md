---
name: slint-preview
description: Execute hot-reloading preview sessions and Slint syntax verification for iterative UI development. Use when validating .slint markup or previewing components.
---
