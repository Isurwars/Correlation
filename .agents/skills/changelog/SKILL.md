---
name: changelog
description: Generate structured CHANGELOG.md files and release notes from Conventional Commits history and git tags. Use when preparing releases or documenting milestones.
---
