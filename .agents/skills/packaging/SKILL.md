---
name: packaging
description: Guide creation of distributable Linux packages (AppImage, DEB, RPM) and release artifacts for the Correlation desktop application. Use when packaging or preparing releases.
---
