# Graph Report - Correlation  (2026-08-01)

## Corpus Check
- 346 files · ~5,143,817 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4553 nodes · 8129 edges · 296 communities (254 shown, 42 thin omitted)
...
## Communities (296 total, 42 thin omitted)
...
### Community 9 - "vector"
Cohesion: 0.09
Nodes (12): map, string, vector, tuple, writeHistogramToCSV, string, CSVWriter::writeAllCSVs(), CSVWriter::writeHistogramToCSV() (+4 more)
...
Cohesion: 0.07
Nodes (30): NearestPoint, ostringstream, pair, real_t, size_t, string, TooltipPosition, vector (+22 more)
...
Cohesion: 0.04
Nodes (49): AppWindow, atomic, map, mutex, RenderTaskData, shared_ptr, size_t, string (+41 more)
...
Cohesion: 0.05
Nodes (37): CalculateVACF_and_VDOS, CalculateVACF_GasLike, CalculateVACF_WithFrameRange, ComputeDiffusionCoefficientVACF_and_RelaxationTime, DistributionFunctionsDynamicProperties, DistributionFunctionsNonPhysicalOptions, DynamicsAnalyzerNonPhysicalInputs, DistributionFunctions (+29 more)
...
Cohesion: 0.04
Nodes (42): AnalysisSettings, active_calculators, angle_bin_width, cancel_flag, dihedral_bin_width, hyperuniformity_samples, lef_cutoff, lef_sigma (+34 more)
...
Cohesion: 0.11
Nodes (19): readTrajectory, readStructure, readTrajectory, readStructure, readTrajectory, readStructure, PresetManager::presetsDirectory(), LLVMFuzzerTestOneInput() (+11 more)
...
Cohesion: 0.18
Nodes (16): handleUpdateTimer, requestPlotUpdate, AppWindow, RenderTaskData, T, PlotController::buildPlotConfigFromUI(), PlotController::executePlotRender(), PlotController::handleClearPinnedRuns() (+8 more)
...
Cohesion: 0.10
Nodes (17): string, PlotConfig, fill_area, font_scale, height, line_width, palette, preset_size (+9 more)
...
Cohesion: 0.07
Nodes (25): CellData, compute_angles_gpu(), AngleTensor, compute_xrd_gpu(), Cell, energy_, getOrRegisterElement, vector (+17 more)
...
### Community 77 - "string"
Cohesion: 0.07
Nodes (34): color(), size_t, mapValue(), map, NearestPoint, ostringstream, pair, real_t (+26 more)
...
Cohesion: 0.11
Nodes (33): element_ids, atomicAdd(), U, compute_distances_gpu(), CORRELATION_DEVICE, CORRELATION_GLOBAL, DistanceTensor, T (+25 more)
...
Cohesion: 0.21
Nodes (12): Color, buildPlotConfigFromUI, executeSavePlot, SharedString, string, getComparisonKey(), parseHexColor(), PlotController::executeSavePlot() (+4 more)
...
Cohesion: 0.13
Nodes (26): cudaStream_t, hipError_t, calculateFrame, dim3, x, y, z, hipDeviceSynchronize() (+18 more)
...
Cohesion: 0.22
Nodes (9): compute_dsq_block(), compute_dsq_block(), compute_dsq_block(), T, PositionBlockT, count, x, y (+1 more)
...
Cohesion: 0.06
Nodes (37): BasicUsage, CreateAnalyzerOutOfBoundsReturnsNullptr, calculateRDF, mutex, calculate, FrameParser, mutex, optional (+29 more)

### Community 297 - "ScaleBinsParams"
Cohesion: 0.29
Nodes (7): scale_bins(), scale_bins(), scale_bins(), ScaleBinsParams, arr, count, scale_factor

### Community 298 - "CarReader.cpp"
Cohesion: 0.53
Nodes (5): CarReader::read(), CarReader::readStructure(), CarReader::readTrajectory(), function, string

### Community 302 - "TEST_F"
Cohesion: 0.27
Nodes (8): Random, BodyCenteredCubic, FaceCenteredCubic, real_t, SimpleCubic, testing::Test, LocalEntropyCalculatorTests, TEST_F()

### Community 303 - "renderTextAsPath"
Cohesion: 0.25
Nodes (3): fmtScientific(), TextAnchor, renderTextAsPath()

### Community 304 - "QEReader"
Cohesion: 0.33
...
### Community 309 - "hipGetDeviceCount"
Cohesion: 0.50
...
## Knowledge Gaps
- **1027 isolated node(s):** `value`, `value`, `value`, `TrajectoryAnalyzer`, `r_max` (+1022 more)
...
- **Why does `DistributionFunctions` connect `AnalysisSettings` to `ChiralityCalculator.cpp`, `MappedFile.hpp`, `addFrame`, `vector`, `AppBackend`, `CSVWriter`, `DistributionFunctions.cpp`, `ThreadLocalDistances`, `PADCalculator.cpp`, `ArcReader.cpp`, `TEST_F`, `readTrajectory`, `FFTUtils.hpp`, `SIMDTypes.hpp`, `TEST_F`, `Trajectory`, `NeighborGraph`, `TEST_F`, `CalculatorFactory`, `XdatcarHeader`, `HDF5Writer`, `HistogramConfigs`, `XRDTests`, `PDF Comparison Renderer`, `Histogram Metadata`, `PartialInfo`, `FileWriter::write`, `TEST_F`, `PYBIND11_MODULE`, `atoms_`, `TEST_F`, `TEST_F`, `XdatcarReaderTests`, `Constants.hpp`, `StructureAnalyzer`, `CNACalculator.cpp`, `ArrowWriter.cpp`, `BaseCalculator`, `XRDCalculator::calculate`, `HBondCalculator.cpp`, `LammpsFrameParser`, `LammpsDumpReader::readTrajectory`, `TEST_F`?**
  _High betweenness centrality (0.215) - this node is a cross-community bridge._
- **Why does `Cell` connect `Constants.hpp` to `ChiralityCalculator.cpp`, `TrajectoryAnalyzer`, `Atom`, `XYZReader`, `LinearAlgebra.hpp`, `vector`, `DistributionFunctions`, `DistributionFunctions.cpp`, `ThreadLocalDistances`, `AppBackend.cpp`, `AnalysisSettings`, `CifReader.cpp`, `FFTUtils.hpp`, `TEST_F`, `TEST`, `TEST_F`, `Trajectory`, `NeighborGraph`, `OutmolParser`, `XdatcarHeader`, `Onetep File Parser`, `Cell`, `TEST`, `VASP XDATCAR Reader`, `TEST_F`, `TEST_F`, `VaspParser`, `TEST`, `GromacsReader`, `TEST_F`, `PYBIND11_MODULE`, `renderComparisonPdf`, `TEST`, `TEST_F`, `TEST_F`, `TEST`, `GPUBond`, `StructureAnalyzer`, `LocalEntropyCalculator.cpp`, `TEST`, `GPUSQCalculator.cu`, `QETrajectoryParser`, `CNCalculator`, `VoronoiCalculator`, `CNACalculator.cpp`, `TEST_F`, `SteinhardtCalculator`, `AppController.cpp`, `StructureFactorCalculator.cpp`, `TEST_F`, `XRDCalculator::calculate`, `.atomCount`, `HBondCalculator.cpp`, `LammpsFrameParser`, `XRDCalculator`, `TEST_F`, `SteinhardtCalculator.cpp`, `addFrame`, `GPULattice`, `PADCalculator.cpp`, `TEST_F`, `readTrajectory`, `computeSingleAtomSteinhardt`, `LammpsDumpReader::readTrajectory`, `HyperuniformityCalculatorTests.cpp`, `VoronoiCalculator::populateHistogram`, `FileIOHandler`, `SDFCalculator`, `MappedFile.hpp`, `HistogramConfigs`, `precomputePhases`, `TEST_F`, `CellReader.cpp`, `FileWriter::write`, `atoms_`, `XdatcarReaderTests`, `BaseReader`, `MappedFile.hpp`, `TEST`, `SIMDTypes.hpp`, `CSVWriter::writeAllCSVs`, `CalculatorFactory`, `readTrajectory`, `XRDTests`, `CarReader.cpp`, `TEST_F`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `AppBackend` connect `AppBackend` to `ProgramOptions`, `PlotController.cpp`, `PresetManager.cpp`, `CNACalculator.cpp`, `GromacsReader.cpp`, `XRDTests`, `vector`, `PyBaseCalculator`, `Main App Controller`, `AnalysisRunner.cpp`, `PlotController`, `InputValidator.cpp`, `AppBackend.cpp`, `AnalysisSettings`, `TEST_F`, `FileIOHandler.cpp`, `TEST_F`, `main.cpp`?**
