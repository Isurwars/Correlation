...
## Corpus Check
- 423 files · ~5,196,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6002 nodes · 10772 edges · 357 communities (312 shown, 45 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 816 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4f7e122`
...
7. `AnalysisSettings` - 66 edges
8. `StructureAnalyzer` - 66 edges
9. `PlotController` - 65 edges
10. `AppBackend` - 63 edges
...
## Communities (357 total, 45 thin omitted)
...
Cohesion: 0.18
Nodes (19): CastepMdReader, parseAtomLine, parseEnergyLine, parseLatticeLine, read, updateProgress, CastepMdReader::parseAtomLine(), CastepMdReader::parseEnergyLine() (+11 more)
...
### Community 9 - "vector"
Cohesion: 0.06
Nodes (12): string, string_view, vector, span, tuple, SDFCalculator::calculateFrame(), VoronoiCalculator::calculateFrame(), function (+4 more)

### Community 10 - "AppBackend"
Cohesion: 0.06
Nodes (49): AbortsGracefullyOnMissingTrajectory, AppBackendIntegrationTests, ApplyScaledBondCutoffs, EndToEndMultiFrameTrajectoryPipeline, AppBackend, applyScaledBondCutoffs, cancel_flag_, df_ (+41 more)
...
Cohesion: 0.06
Nodes (39): calculateAshcroftWeights, ensureNeighborsComputed, neighbors, smooth, RDFParams, r_bin_width, r_max, TrajectoryAnalyzer (+31 more)
...
Cohesion: 0.13
Nodes (31): AppErrors, AppController, AppWindow, InputValidator, backend_, controller_, validateAngularAndRings, validateExportConfig (+23 more)
...
Cohesion: 0.12
Nodes (24): getRecommendedBondCutoffs, AppBackend::applyScaledBondCutoffs(), AppBackend::getAshcroftWeights(), AppBackend::getAtomCounts(), AppBackend::getAvailableHistogramNames(), AppBackend::getBondCutoff(), AppBackend::getHistogram(), AppBackend::getMinBondCutoff() (+16 more)
...
Cohesion: 0.09
Nodes (37): GPUXRDParams, bin_width, lambda, theta_max, theta_min, real_t, assemble_histogram(), build_element_coeffs() (+29 more)

### Community 24 - "AppDefaults"
Cohesion: 0.06
Nodes (36): AppDefaults, ANGLE_BIN_WIDTH, ANGLE_BIN_WIDTH_CRYSTAL, ANGLE_BIN_WIDTH_LIQUID, LEF_CUTOFF, LEF_SIGMA, MSG_ANALYSIS_ABORTED, MSG_ANALYSIS_ENDED (+28 more)
...
Cohesion: 0.06
Nodes (31): BondCutoffMatrix, KernelType, map, ProgramOptions, active_calculators, angle_bin_width, bond_cutoffs, dihedral_bin_width (+23 more)
...
Cohesion: 0.11
Nodes (19): readTrajectory, readStructure, readTrajectory, readStructure, readTrajectory, readStructure, readStructure, LLVMFuzzerTestOneInput() (+11 more)
...
Cohesion: 0.21
Nodes (12): executeWriteFiles, startLoadingTrajectory, AppController, AppWindow, string, FileIOHandler::executeWriteFiles(), FileIOHandler::FileIOHandler(), FileIOHandler::handleBrowseFile() (+4 more)
...
Cohesion: 0.08
Nodes (40): AnalysisRunner, AppController, analysis_runner_, file_io_handler_, handleApplyScaledCutoffs, handleClearComparisonCurves, handleOptionsfromUI, handleOptionstoUI (+32 more)
...
### Community 53 - "TEST_F"
Cohesion: 0.04
Nodes (40): AnalysisSettings, active_calculators, angle_bin_width, cancel_flag, dihedral_bin_width, frame_stride, hyperuniformity_samples, lef_cutoff (+32 more)
...
Cohesion: 0.10
Nodes (19): DoublePrecisionDistanceComputation, FloatPrecisionDistanceComputation, GPUDistanceCalculatorTests, HasGPUDeviceCheck, compute_angles_gpu(), AngleTensor, vector, NeighborGraph (+11 more)

### Community 59 - "SvgComparisonRenderer"
Cohesion: 0.09
Nodes (23): BondDistanceAboveMaxCutoffProducesNoAngles, BondDistanceBelowMinCutoffProducesNoAngles, BondDistanceWithinCutoffRangeProducesAngle, CalculatePAD, EmptyCellThrows, EquilateralTriangle60, FullNormalizationCheck, Icosahedron_13Atoms (+15 more)
...
Cohesion: 0.08
Nodes (28): color(), ColorStop, b, g, r, t, size_t, string (+20 more)
...
Cohesion: 0.05
Nodes (27): DistributionFunctions, ashcroft_weights_, bond_cutoffs_, current_cutoff_, dynamic_properties_, getInversePartialKey, getPartialKey, histogram_mutex_ (+19 more)
...
Cohesion: 0.06
Nodes (31): mutex, AngleTensor, atomic, BondCutoffMatrix, DihedralTensor, mutex, RawHistogramTensor, real_t (+23 more)
...
Cohesion: 0.12
Nodes (24): hipGetDeviceCount(), has_gpu_device(), averageBinnedSQ(), CORRELATION_HOST(), CORRELATION_DEVICE, CORRELATION_GLOBAL, real_t, T (+16 more)
...
### Community 87 - "TEST_F"
Cohesion: 0.11
Nodes (17): ConstructorInitializesCorrectly, GuiLaunchAndEventLoopSmokeTest, HandlesBondCutoffsCorrectly, HandlesCalculatorToggleSignal, HandlesXRDOptionsAndCutoffHeuristics, string, MiniSideBarPanelNavigationAndCollapse, PopulatesRecommendedBondCutoffs (+9 more)

### Community 88 - "PhysicalData.hpp"
Cohesion: 0.09
Nodes (19): string, vector, NequipReader, parseCommentLine, parseEnergy, parseLattice, parseProperties, parsePropertiesParts (+11 more)
...
### Community 91 - "TEST_F"
Cohesion: 0.22
Nodes (9): BuildBCCLatticeAndVerifyDensity, BuildFCCLatticeAndVerifyPBCDistances, minimumImage, volume_, CellFunctionalTests, testing::Test, TEST_F(), VerifyLatticeParameterGuards (+1 more)
...
Cohesion: 0.10
Nodes (20): BinRange, string_view, VoronoiCalculator, buildSignatureMap, calculate, calculateFrame, computeVoronoiCells, makeHistogram (+12 more)
...
Cohesion: 0.16
Nodes (14): AppController, AppWindow, FileIOHandler, dialog_active_, dialog_thread_, handleBrowseFile, handleReloadFile, handleWriteFiles (+6 more)
...
Cohesion: 0.10
Nodes (42): accumulate_histograms(), AtomPair, i_val, j_val, type_A, type_B, build_spatial_partition(), compute_distances_gpu() (+34 more)
...
Cohesion: 0.15
Nodes (16): AppController::handleApplyScaledCutoffs(), AppController::handleOptionsfromUI(), AppController::handleOptionstoUI(), AppController::handleResetAdvancedOptions(), AppController::handleResetAngleOptions(), AppController::handleResetRDFOptions(), AppController::handleResetRingsOptions(), AppController::handleResetSmoothingOptions() (+8 more)
...
Cohesion: 0.24
Nodes (8): HexagonalClosePacked, BodyCenteredCubic, FaceCenteredCubic, real_t, SimpleCubic, testing::Test, TEST_F(), VoronoiCalculatorTests
...
Cohesion: 0.06
Nodes (66): LocalAccumulatorTuple, buildPartialsInfo(), buildTypeBlocks(), combineAccumulators(), computeReciprocalBasis(), CoordinateArrays, x, y (+58 more)
...
Cohesion: 0.09
Nodes (32): cudaStream_t, DeviceBuffer, count_, ptr_, size_t, T, GPUError, hipCheck() (+24 more)
...
Cohesion: 0.09
Nodes (41): map, real_t, string, vector, MotifProjectedTDOS, energies, frame_count, motif_tdos (+33 more)
...
Cohesion: 0.08
Nodes (23): BasicCalculation, BasicClustering, CalculateSDF, ClusterCalculatorTests, IcosahedronAnglesDAD, calculateFrame, setLatticeParameters, MultiAtomSDFHasNonzeroDensity (+15 more)
...
Cohesion: 0.15
Nodes (9): DataRange, max, min, real_t, NiceScale, max, min, spacing (+1 more)
...
Cohesion: 0.19
Nodes (18): progress_callback, function, optional, real_t, string, parsePdbAtomLine(), parsePdbCrystLine(), PdbAtomData (+10 more)
...
Cohesion: 0.10
Nodes (33): calculateFrame, compute_y4m(), compute_y6m(), CORRELATION_DEVICE, CORRELATION_GLOBAL, T, GPUPoint, x (+25 more)
...
Cohesion: 0.11
Nodes (27): Histogram, bins, compute_count, description, file_suffix, partials, smoothed_partials, title (+19 more)

### Community 295 - "XRDTests"
Cohesion: 0.04
Nodes (52): BasicUsage, CalculatesAndWritesSiliconDistributions, CreateAnalyzerOutOfBoundsReturnsNullptr, DADCsvAndRawCsvAreCreated, calculateDAD, calculateRDF, calculateVACF, calculateVDOS (+44 more)
...
Cohesion: 0.67
Nodes (4): elements_, getFrame, Trajectory::precomputeBondCutoffs(), Trajectory::validateFrame()
...
### Community 306 - "TEST"
Cohesion: 0.15
Nodes (14): CorrelationEngineConfig, bond_cutoffs, max_frame, min_frame, settings, time_step, BondCutoffMatrix, real_t (+6 more)
...
Cohesion: 0.10
Nodes (29): DetectsNewerVersionsCorrectly, HandlesMissingFieldsInReleaseJson, AppWindow, string, ReleaseInfo, html_url, tag_name, UpdateChecker (+21 more)
...
Cohesion: 0.17
Nodes (11): atoms_, real_t, vector, Vector3, MLIPOutput, forces, ldos, ldos_bins (+3 more)
...
Cohesion: 0.36
Nodes (7): AnalysisRunner, analysis_thread_, handleRunAnalysis, updateProgress, AppController, AppWindow, thread
...
Cohesion: 0.04
Nodes (70): CellData, GPUSQCalculatorTests, calculateFrame, Cell, energy_, getOrRegisterElement, real_t, vector (+62 more)
...
## Knowledge Gaps
- **1388 isolated node(s):** `mcp-reminder.sh script`, `value`, `value`, `value`, `min_sq` (+1383 more)
...
- **Why does `Cell` connect `HyperuniformityCalculatorTests.cpp` to `PDF Generation Utilities`, `ChiralityCalculator.cpp`, `TrajectoryAnalyzer`, `Atom`, `XYZReader`, `LinearAlgebra.hpp`, `vector`, `AppBackend`, `DistributionFunctions.cpp`, `ThreadLocalDistances`, `CastepMdReader`, `AnalysisSettings`, `CifReader.cpp`, `FFTUtils.hpp`, `TEST_F`, `TEST`, `TEST_F`, `Trajectory`, `NeighborGraph`, `OutmolParser`, `Onetep File Parser`, `Cell`, `Histogram Metadata`, `TEST`, `VASP XDATCAR Reader`, `TEST_F`, `TEST_F`, `TEST`, `TEST_F`, `GromacsReader`, `TEST_F`, `renderComparisonPdf`, `TEST`, `TEST_F`, `TEST_F`, `Constants.hpp`, `TEST`, `GPUBond`, `StructureAnalyzer`, `LocalEntropyCalculator.cpp`, `TEST`, `Cell.cpp`, `GPUSQCalculator.cu`, `QETrajectoryParser`, `CNCalculator`, `PhysicalData.hpp`, `TEST_F`, `TEST_F`, `VoronoiCalculator`, `CNACalculator.cpp`, `TEST_F`, `DatasetWriteQuery`, `AppController.cpp`, `NiceScale`, `StructureFactorCalculator.cpp`, `TEST_F`, `XRDCalculator::calculate`, `.atomCount`, `XRDCalculator`, `HBondCalculator.cpp`, `LammpsFrameParser`, `TEST_F`, `SteinhardtCalculator.cpp`, `addFrame`, `UnionFind`, `GPULattice`, `PADCalculator.cpp`, `TEST_F`, `wasm_bindings.cpp`, `readTrajectory`, `computeSingleAtomSteinhardt`, `LammpsDumpReader::readTrajectory`, `HyperuniformityCalculatorTests.cpp`, `VoronoiCalculator::populateHistogram`, `FileIOHandler`, `SDFCalculator`, `MappedFile.hpp`, `Caveman Communication & Token Economy Protocol`, `HistogramConfigs`, `precomputePhases`, `CellReader.cpp`, `TEST`, `FileIOHandler.cpp`, `PlotController::requestPlotUpdate`, `XdatcarReaderTests`, `PlotSize`, `PositionBlockT`, `compute_distances_gpu`, `BaseReader`, `TEST`, `computeSingleAtomSteinhardt`, `GromacsReaderTests`, `CalculatorFactory`, `HDF5Writer.cpp`, `XRDTests`, `OutmolReader.cpp`, `TrajectoryAnalyzer::TrajectoryAnalyzer`, `PlotController::PlotController`, `BinningConfig`, `QEReader`, `VaspReaderTests`, `SYCLAngleParams`, `QVector`, `BlendParams`, `PresetController`, `MLIPInterface`, `SYCLXRDParams`, `core_bindings.cpp`, `MLIPCalculatorTests.cpp`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `DistributionFunctions` connect `GPUBond` to `GPUSteinhardtCalculator.cu`, `ChiralityCalculator.cpp`, `addFrame`, `vector`, `AppBackend`, `CSVWriter`, `DistributionFunctions.cpp`, `UnionFind`, `ThreadLocalDistances`, `PADCalculator.cpp`, `ArcReader.cpp`, `TEST_F`, `wasm_bindings.cpp`, `AnalysisSettings`, `computeSingleAtomSteinhardt`, `CalculatorFactory`, `TEST_F`, `SDFCalculator`, `Caveman Communication & Token Economy Protocol`, `HDF5Writer`, `CSVWriter::writeAllCSVs`, `XRDTests`, `PDF Comparison Renderer`, `PartialInfo`, `HistogramConfigs`, `TEST`, `TEST`, `TEST_F`, `TEST_F`, `PYBIND11_MODULE`, `SvgComparisonRenderer`, `TEST_F`, `PlotController::requestPlotUpdate`, `Constants.hpp`, `StructureAnalyzer`, `TEST`, `TEST`, `CNACalculator.cpp`, `BaseCalculator`, `SteinhardtCalculator`, `DatasetWriteQuery`, `SYCLXRDParams`, `XRDCalculator::calculate`, `HyperuniformityCalculatorTests.cpp`, `HBondCalculator.cpp`, `LammpsFrameParser`, `CliParserTests`, `TEST_F`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `Trajectory` connect `XRDTests` to `PDF Generation Utilities`, `TEST`, `TrajectoryAnalyzer`, `Atom`, `XYZReader`, `vector`, `AppBackend`, `computeSingleAtomSteinhardt`, `DistributionFunctions.cpp`, `UnionFind`, `GPULattice`, `wasm_bindings.cpp`, `readTrajectory`, `CastepMdReader`, `computeSingleAtomSteinhardt`, `CifReader.cpp`, `TEST_F`, `GromacsReaderTests`, `TEST_F`, `Trajectory`, `MappedFile.hpp`, `readTrajectory`, `Caveman Communication & Token Economy Protocol`, `Onetep File Parser`, `VASP XDATCAR Reader`, `TrajectoryAnalyzer::TrajectoryAnalyzer`, `TEST_F`, `GPUSearchGrid`, `PlotController::PlotController`, `TEST`, `CellReader.cpp`, `TEST`, `TEST_F`, `TEST`, `VaspReaderTests`, `QEReader`, `PYBIND11_MODULE`, `BinningConfig`, `GromacsReader`, `TEST_F`, `TEST_F`, `TEST_F`, `PlotController::requestPlotUpdate`, `Constants.hpp`, `GPUBond`, `BlendParams`, `StructureAnalyzer`, `QETrajectoryParser`, `CNCalculator`, `PhysicalData.hpp`, `PresetController`, `TEST_F`, `MLIPInterface`, `DatasetWriteQuery`, `core_bindings.cpp`, `HyperuniformityCalculatorTests.cpp`, `.atomCount`, `DihedralCalculatorTests`, `PositionBlockT`, `CliParserTests`, `BaseReader`?**
