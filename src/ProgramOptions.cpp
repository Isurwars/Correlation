...
void ProgramOptions::printHelp() {
  ...
  const std::string help_txt =
      ...
      "same\n"
      "        as the shortest length of the periodic boundary conditions "
      "(PBC), \n"
      "        anything above this value can be affected by periodic "
      "interactions.\n\n"
      "    BOND-ANGLE OPTIONS:\n"
      "      -a, --angle_bin_width\n"
      ...
      "        By default the bond_parameter is set to 1.20, as a rule of "
      "thumb.\n"
      ...
      "        A bond_parameter of 1.4 is recomended for amorphous "
      "materials.\n\n"
      "    OUTPUT OPTIONS:\n"
      "      -o, --out_file\n"
