...
static const bool registered = ReaderFactory::instance().registerReader(std::make_unique<LammpsDumpReader>()); // NOLINT(cert-err58-cpp, bugprone-throwing-static-initialization)
