...
static bool registered = ReaderFactory::instance().registerReader(std::make_unique<XdatcarReader>()); // NOLINT(cert-err58-cpp, bugprone-throwing-static-initialization)
