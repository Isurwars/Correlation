 ...
 * @brief Implementation of distribution function calculations.
...
#include "calculators/spatial/DADCalculator.hpp"
#include "calculators/spatial/PADCalculator.hpp"
#include "calculators/spatial/RDFCalculator.hpp"
#include "calculators/temporal/VACFCalculator.hpp"
#include "calculators/temporal/VDOSCalculator.hpp"
...
void DistributionFunctions::add(const DistributionFunctions &other) {
  ...
  for (const auto &[name, other_hist] : other.histograms_) {
    ...
    for (const auto &[key, other_partial] : other_hist.partials) {
      if (!this_hist.partials.contains(key)) {
