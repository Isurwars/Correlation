...
#if __cplusplus >= 202002L || (defined(_MSVC_LANG) && _MSVC_LANG >= 202002L)
constexpr real_t pi = static_cast<real_t>(std::numbers::pi); // NOLINT(readability-identifier-length)
#else
...
constexpr real_t angstrom_to_bohr = static_cast<real_t>(1.0) / bohr_to_angstrom; ///< Conversion factor: Angstroms to Bohr
