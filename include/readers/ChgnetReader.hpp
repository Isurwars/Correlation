 ...
 * @brief Reader for CHGNet (Crystal Hamiltonian Graph Neural Network) Extended XYZ trajectory
 * files.
...
public:
  ...
  /**
   * @struct CommentData
   * @brief Intermediate storage for parsed CHGNet Extended XYZ comment line metadata and column
   * layout.
   */
  struct CommentData {
