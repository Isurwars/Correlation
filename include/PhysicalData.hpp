    ...
    static const std::unordered_map<std::string, std::vector<double>> factors =
        {
            ...
            {"Pd",
             {19.3319, 0.698655, 15.5017, 7.98929, 5.29537, 25.2052, 0.605844,
              76.8986, 5.26593}},
            {"Ag",
             {19.2808, 0.6446, 16.6885, 7.4726, 4.8045, 24.6605, 1.0463,
              99.8156, 5.179}},
            {"Cd",
             {19.2214, 0.5946, 17.6444, 6.9089, 4.461, 24.7008, 1.6029, 87.4825,
              5.0694}},
            {"In",
             {19.1624, 0.5476, 18.5596, 6.3776, 4.2948, 25.8499, 2.0396,
              92.8029, 4.9391}},
            {"Sn",
             {19.1889, 5.8303, 19.1005, 0.5031, 4.4585, 26.8909, 2.4663,
              83.9571, 4.7821}},
            {"Sb",
             {19.6418, 5.3034, 19.0455, 0.4607, 5.0371, 27.9074, 2.6827,
              75.2825, 4.5909}},
            {"Te",
            ...
            {"Sm",
             {24.0042, 2.47274, 19.4258, 0.196451, 13.4396, 14.3996, 2.89604,
              128.007, 2.20963}},
            {"Eu",
             {24.6274, 2.3879, 19.0886, 0.1942, 13.7603, 13.7546, 2.9227,
              123.174, 2.5745}},
            {"Gd",
            ...
            {"Ta",
             {29.2024, 1.77333, 15.2293, 9.37046, 14.5135, 0.295977, 4.76492,
              63.3644, 9.24354}},
            {"W",
             {29.0818, 1.72029, 15.43, 9.2259, 14.4327, 0.321703, 5.11982,
              57.056, 9.8875}},
            {"Re",
            ...
            {"At",
             {35.3163, 0.68587, 19.0211, 3.97458, 9.49887, 11.3824, 7.42518,
              45.4715, 13.7108}},
            {"Rn",
             {35.5631, 0.6631, 21.2816, 4.0691, 8.0037, 14.0422, 7.4433,
              44.2473, 13.6905}},
            {"Fr",
            ...
            {"Pa",
             {35.8847, 0.547751, 23.2948, 3.41519, 14.1891, 16.9235, 4.17287,
              105.251, 13.4287}},
            {"U",
             {36.0228, 0.5293, 23.4128, 3.3253, 14.9491, 16.0927, 4.188,
              100.613, 13.3966}},
            {"Np",
